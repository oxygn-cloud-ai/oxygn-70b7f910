...
const ParentPromptPopup = ({ isOpen, onClose, parentData, cascadeField, onCascade, treeData }) => {
  ...
  const renderField = (label, content, isLastField = false) => (
    <div className="mb-4">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] h-[80vh] flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto">
          {isLoading ? (
            ...
            <>
              ...
              {renderField("User Prompt Result", selectedItem.user_prompt_result || '', true)}
            </>
          ) : (
            <div className="flex justify-center items-center h-full">
        ...
        {isAccordionVisible && (
          <div className="mt-4 border rounded-lg p-4 overflow-x-auto overflow-y-auto max-h-60">
            <Accordion
              type="multiple"
              value={expandedItems}
