          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="w-8 h-8 flex items-center justify-center rounded-m3-full bg-primary text-on-primary hover:bg-primary/90 disabled:opacity-50"
              >
          ...
          <SettingRow label="Topic" description="Category for this knowledge">
            <div className="relative">
              <button
                ...
                className="h-8 px-3 flex items-center gap-2 bg-surface-container rounded-m3-sm border border-outline-variant text-body-sm text-on-surface"
              >
                ...
                <div className="absolute top-full left-0 mt-1 w-48 bg-surface-container-high rounded-m3-md shadow-lg border border-outline-variant z-10 py-1 max-h-48 overflow-auto">
                  {topics.map(topic => (
                    <button
                      ...
                      className={`w-full px-3 py-1.5 text-left text-body-sm hover:bg-surface-container ${
                        formData.topic === topic ? 'text-primary' : 'text-on-surface'
                      }`}
                    >
                      {topic.replace('_', ' ')}
                    </button>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={addKeyword}
              className="h-8 px-3 bg-surface-container rounded-m3-sm border border-outline-variant text-body-sm text-on-surface-variant hover:bg-surface-container-high"
            >
              Add
            </button>
          </div>
