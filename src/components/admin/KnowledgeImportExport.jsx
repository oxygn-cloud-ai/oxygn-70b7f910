  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col bg-surface-container-low">
        <DialogHeader>
          <DialogTitle className="text-title-sm text-on-surface">
        ...
        <div className="flex items-center justify-between text-body-sm text-on-surface-variant mb-2">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="h-7 px-2.5 flex items-center gap-1.5 rounded-m3-sm bg-surface-container text-on-surface-variant hover:bg-surface-container-high text-[11px]"
            >
            ...
            <button
              ...
              className="h-7 px-2.5 flex items-center gap-1.5 rounded-m3-sm bg-primary text-on-primary hover:bg-primary/90 text-[11px]"
            >
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col bg-surface-container-low">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <button
            ...
            className="h-8 px-3 flex items-center gap-2 rounded-m3-sm bg-surface-container text-on-surface-variant hover:bg-surface-container-high text-body-sm"
          >
        ...
        {parseResult && (
          <div className={`p-3 rounded-m3-md ${parseResult.valid ? 'bg-green-500/10' : 'bg-red-500/10'}`}>
            {parseResult.error ? (
              <div className="flex items-start gap-2 text-red-500 text-body-sm">
        ...
        <div className="flex items-center justify-end gap-2 pt-2">
          <button
            ...
            className="h-8 px-4 rounded-m3-sm text-body-sm text-on-surface-variant hover:bg-surface-container"
          >
            Cancel
          </button>
          <button
