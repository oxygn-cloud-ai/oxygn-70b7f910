  ...
  create_children_json: {
    ...
    configSchema: [
      ...
      },
      {
        ...
        label: 'Name Field',
        type: CONFIG_FIELD_TYPES.TEXT,
        defaultValue: 'prompt_name',
        required: false,
        helpText: 'Field in each array item to use as prompt name (e.g., "prompt_name", "title"). Leave empty for auto-detection.',
      },
      {
        key: 'content_field',
        label: 'Content Field',
        type: CONFIG_FIELD_TYPES.TEXT,
        defaultValue: 'input_admin_prompt',
        required: false,
        helpText: 'Field to use as child prompt content (e.g., "input_admin_prompt", "content"). Leave empty to use entire item as JSON.',
      },
      {
