        ...
        <CardContent className="space-y-6 pt-4">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-body-sm text-on-surface-variant">Email</Label>
              <Input
                id="email"
                type="email"
                placeholder="james@oxygn.cloud"
                value={email}
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-body-sm text-on-surface-variant">Password</Label>
              <div className="relative">
                <Input
                  id="password"
